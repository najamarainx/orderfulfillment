                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="number" class="form-control" name="customer_no" id="customer_no"
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="email" class="form-control" name="customer_email"
                                            id="customer_email" placeholder="Customer Email">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group mb-4">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group mb-4">
                                        ...
                                        <textarea type="text" class="form-control" placeholder="Customer Address"
                                            name="customer_address" id="customer_address"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group mb-4">
                                        <label class="mb-0">Customer postal Code</label>
                                        <input type="number" class="form-control" name="customer_post_code"
                                            id="customer_post_code" placeholder="Customer postal Code">
                                    </div>
                                </div>
                            </div>
                            <div class="row" id="set_ctg">
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-4">
                                        ...
                                        <input class="form-group mb-4 date selected_date" id="datepicker" name="date"
                                            autocomplete="off" />
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group mb-4">
                                        ...
                                        <select class="form-control form-control-lg  kt_select2_1 w-100 zip_code"
                                            data-live-search="true" name="zip_code" id="zip_code">
                                            @if(!empty($zipCode))
                                            <option value=""></option>
