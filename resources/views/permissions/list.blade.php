                ...
                <form id="addForm" >
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="dropdown bootstrap-select form-control datatable-input"><select class="form-control selectpicker datatable-input" name="category_id" id="category_id" data-live-search="true">
