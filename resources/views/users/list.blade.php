                                ...
                                <div class="table-responsive">
                                    <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_3">
                                        ...
                                        <tr class="text-left text-uppercase">
                                            <th class="px-0" style="width: 50px">Sr</th>
                                           <th style="min-width: 120px">Name</th>
                                            <th style="min-width: 120px">Email</th>
                                            <th class="text-info" style="min-width: 150px">Phone. No</th>
                                            <th class="text-info" style="min-width: 150px">Role</th>
                                            <th class="text-info" style="min-width: 150px">User Type</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-dark-75 font-weight-normal d-block font-size-lg">+4 256 111541</span>
                                            </td>
                                            <td>
                                                <span class="text-dark-75 font-weight-normal d-block font-size-lg">38 Guild Street, LONDON</span>
                                            </td>
                                            <td>
                                                <span class="text-dark-75 font-weight-normal d-block font-size-lg">23/01/2022</span>
                                            </td>
