...
class BookingController extends Controller
{
    ...
    public function getList(Request $request)
    {
        ...
        $booking = DB::table('orderfulfillment_bookings')->whereNull('orderfulfillment_bookings.deleted_at')->leftJoin('orderfulfillment_time_slots as ots','orderfulfillment_bookings.time_slot_id','ots.id')->whereNull('ots.deleted_at');
